...
function Build-Prompt {
    ...
    [void]$lines.Add("- Branch $Branch anlegen. Basis-Branch je nach Repo:")
    [void]$lines.Add("    * In $RepoOne: aus 'feature/l10n-portal' abzweigen (NICHT aus master), damit Phase-0-Outputs (phase0/, ADR 0010, RESULT_PHASE_0.md) verfuegbar sind.")
    [void]$lines.Add("    * In Portal- oder Suite-Repo: aus dem dortigen Default-Branch (master/main).")
    [void]$lines.Add("- Alle Aenderungen darin committen (Conventional Commits).")
