...
| Freigabe | — | Mensch im Portal (beta: Ersteller; stable: kein Zweit-Admin — **nicht gebaut**, Stand 06.09.2026, gemessen in `AdminReleases.razor`, Methode `Freigeben` — Portal-Commit `3c65926`; Welle `portal-freigabe-4augen` offen) |
