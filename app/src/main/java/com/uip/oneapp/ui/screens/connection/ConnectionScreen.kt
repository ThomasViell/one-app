            ...
            Row(
                ...
                Button(
                    ...
                    if (state.isScanning) {
                        ...
                        Icon(Icons.Default.Search, contentDescription = null, modifier = Modifier.size(Dimensions.IconSizeSmall))
                    }
                    Spacer(modifier = Modifier.width(Dimensions.SmallSpacing))
    ...
    Row(
        ...
        FilledTonalButton(
            ...
            if (isTestingThis) {
                ...
                Icon(Icons.Default.NetworkCheck, contentDescription = null, modifier = Modifier.size(Dimensions.IconSizeXSmall))
            }
            Spacer(modifier = Modifier.width(Dimensions.SmallSpacing))
...
private fun RtspResultItem(
    ...
    Row(
        ...
        Button(
            onClick = onConnect,
            modifier = Modifier
                .padding(start = Dimensions.SectionSpacing)
                .height(Dimensions.TouchMedium),
        ...
        Column(modifier = Modifier.padding(Dimensions.PanelEdgePadding)) {
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(Dimensions.SectionSpacing)) {
                OutlinedButton(
                    ...
                    if (isTesting) {
                        CircularProgressIndicator(modifier = Modifier.size(Dimensions.IconSizeXSmall), strokeWidth = Dimensions.StrokeWidthMedium)
                    } else {
                        Icon(Icons.Default.NetworkCheck, contentDescription = null, modifier = Modifier.size(Dimensions.IconSizeSmall))
                    }
                    Spacer(modifier = Modifier.width(Dimensions.SmallSpacing))
                    Text(S("test"))
                }
            ...
            Row(
                ...
                OutlinedButton(
                    ...
                    if (isProbing) {
                        ...
                        Icon(Icons.Default.Search, contentDescription = null, modifier = Modifier.size(Dimensions.IconSizeXSmall))
                    }
                    Spacer(modifier = Modifier.width(Dimensions.SmallSpacing))
...
private fun InfoRow(label: String, value: String) {
    Row(
        ...
        Text(
            ...
            style = MaterialTheme.typography.bodySmall,
            color = Color.Gray,
            modifier = Modifier.width(Dimensions.LabelColumnWidth)
        )
        Text(
            text = value,
            style = MaterialTheme.typography.bodySmall,
